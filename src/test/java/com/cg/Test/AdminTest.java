...
class AdminTest {
	...
	final void testAddAdminFirstName1() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,First name should not contain digit.,[]>", adminController.addAdmin(new Admin(101, "First1", "Last", "email@gmail.com", "9000000000", "password")).toString());
	...
	final void testAddAdminLastName1() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Last name should not contain digit.,[]>", adminController.addAdmin(new Admin(101, "First", "Last1", "email@gmail.com", "9000000000", "password")).toString());
	...
	final void testAddAdminFirstName2() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,First name is not valid.,[]>", adminController.addAdmin(new Admin(101, "First!@", "Last", "email@gmail.com", "9000000000", "password")).toString());
	...
	final void testAddAdminLastName2() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Last name is not valid.,[]>", adminController.addAdmin(new Admin(101, "First", "Last!@", "email@gmail.com", "9000000000", "password")).toString());
	...
	final void testAddAdminContactNumber1() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Contact number is not valid, must be of 10 digits.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "90000", "password")).toString());
	...
	final void testAddAdminContactNumber2() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Contact number is not valid, must be numeric.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "90000000**", "password")).toString());
	...
	final void testAddAdminPassword1() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password should be minimum 8 length.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "pass")).toString());
	...
	final void testAddAdminPassword2() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password must contain at least one uppercase character.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "password")).toString());
	...
	final void testAddAdminPassword3() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password must contain at least one lowercase character.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "PASSWORD")).toString());
	...
	final void testAddAdminPassword4() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password must contain at least one digit.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "PASSword")).toString());
	...
	final void testAddAdminPassword5() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password must contain at least one special character from !,@,#,$,%,*.,[]>", adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "Password123")).toString());
	...
	final void testAddAdminPassword6() {
		...
		assertEquals("<400 BAD_REQUEST Bad Request,Password does not match the policy, "
				+ "it should contain at least one uppercase character, lowercase character, digit and special character.,[]>", 
				adminController.addAdmin(new Admin(101, "First", "Last", "email@gmail.com", "9000000000", "Password@123<>")).toString());
	...
	final void testRemoveAllAdmin1() {
		...
		assertEquals("All admin deleted successfully.", adminController.removeAllAdmin());
	...
	final void testGetAllAdmin1() {
		...
		assertEquals("<200 OK OK,Admin not found.,[]>", adminController.getAllAdmin().toString());
	...
	final void testGetAdminSortedByFirstName() {
		...
		adminController.addAdmin(new Admin("Onkar", "Magadum", "email1@gmail.com", "9000000000", "Password@123"));
		adminController.addAdmin(new Admin("Abc", "Xyz", "email2@gmail.com", "8000000000", "Password@123"));
		adminController.addAdmin(new Admin("Mno", "Pqr", "email3@gmail.com", "7000000000", "Password@123"));
		adminController.addAdmin(new Admin("First", "Last", "email4@gmail.com", "6000000000", "Password@123"));
		...
		assertEquals("<200 OK OK,["
				...
				+ "Admin [First_Name=First, Last_Name=Last, Email=email4@gmail.com, Contact_Number=6000000000, Password=Password@123], "
