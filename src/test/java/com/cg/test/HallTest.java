...
import com.cg.controller.HallController;
...
public class HallTest {
    ...
    final void testAddHallName(){
        ...
        List<HallOffers> hallOffersList;
        hallOffersList.add(hallOffers1);
        hallOffersList.add(hallOffers2);
        assertEquals("<400 BAD_REQUEST Bad Request,Name should not contain digit.,[]>", hallController.addHall(new Hall(101, "Hall1",6, 9000, "kakadeo", "Kanpur", 500000, false,vendor,hallOffers)).toString());
    }
